...
int main(void)
{
    ...
    printf("%s\n%s%s\n%s%s\n%s%s\n%s%s\n%s%s\n\n","According to isxdigit: ",
           isdigit('F') ? "F is a " : "F is not a ","hexadecimal digit",
           isdigit('J') ? "J is a " : "J is not a ","hexadecimal digit",
           isdigit('7') ? "7 is a " : "7 is not a ","hexadecimal digit",
           isdigit('$') ? "$ is a " : "$ is not a ","hexadecimal digit",
           isdigit('f') ? "f is a " : "f is not a ","hexadecimal digit");
